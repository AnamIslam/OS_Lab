...
bool sortByBurstTime(process time1, process time2)
{
    return (time1.pBurstTime<time2.pBurstTime);
}
...
//    time = 0;
    ...
    for(i=0;i<n;i++)
    {
        a[i].pTurnAroundTime= a[i].pEnd-a[i].pArrivalTime;//+1;
